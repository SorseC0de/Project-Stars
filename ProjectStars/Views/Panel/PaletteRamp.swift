...
enum PaletteRamp {
    ...
    private static let ramps: [[Color]] = [
        ...
        [Palette.cream, Palette.khaki, Palette.brown, Palette.darkBrown,
         Palette.maroon, Palette.coffee, Palette.mocha],
        [Palette.yellowGreen, Palette.yellow, Palette.gold, Palette.orange,
         Palette.darkBrown],
        [Palette.neonGreen, Palette.lime, Palette.green, Palette.darkGreen,
         Palette.forest, Palette.turqoise],
        [Palette.ice, Palette.cyan, Palette.sky, Palette.blue,
        ...
        [Palette.lavender, Palette.pewter, Palette.midnight],
